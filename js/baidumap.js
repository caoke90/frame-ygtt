...
head.js("http://api.map.baidu.com/getscript?v=1.4&key=&services=&t=20130219081854",function(){
var mconfig={
	id:"allmap",
	zoom:"14",
	center:"",
...
mconfig.center=$("#"+mconfig.id).text();
mconfig.zoom=parseInt($("#"+mconfig.id).attr("zoom"));
